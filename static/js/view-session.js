var status_badge = {
    ...
    "Started": '<h6 class="card-subtitle mb-2 text-muted"><span class="badge badge-secondary">Started</span></h6>',
    "Ended": '<h6 class="card-subtitle mb-2 text-muted"><span class="badge badge-secondary">Ended</span></h6>'
};
